...
from adapters.catalog_loader import load_catalog
from adapters.google_shopping.merchant_center import load_catalog as load_merchant_catalog

DATA_PATH = Path(__file__).resolve().parents[1] / "data" / "google_merchant_feed.json"
