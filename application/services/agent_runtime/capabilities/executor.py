...
from application.services.agent_runtime.capabilities.support import (
    ...
    is_control_variant_row as _is_control_variant_row,
    latest_analytics_event_for_variant as _latest_analytics_event_for_variant,
    latest_metric_for_variant as _latest_metric_for_variant,
    resolve_control_variant_id as _resolve_control_variant_id,
