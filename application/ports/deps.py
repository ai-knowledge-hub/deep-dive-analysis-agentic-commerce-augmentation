...
class SimulationRunsStore(Protocol):
    ...
    def delete_run(self, **kwargs: Any) -> bool: ...
...
class ExperimentsStore(Protocol):
    ...
    def delete_experiment(self, **kwargs: Any) -> bool: ...
...
class ValidationJobsStore(Protocol):
    def create_job(self, **kwargs: Any) -> dict: ...

    def update_job_status(self, **kwargs: Any) -> dict | None: ...

    def get_job(self, **kwargs: Any) -> dict | None: ...

    def list_jobs(self, **kwargs: Any) -> list[dict]: ...


class ValidationResultsStore(Protocol):
    def create_result(self, **kwargs: Any) -> dict: ...
...
class LLMProviderConfigsStore(Protocol):
    def list_configs(self) -> list[dict]: ...

    def get_config(self, **kwargs: Any) -> dict | None: ...

    def get_active_provider(self) -> str | None: ...

    def upsert_config(self, **kwargs: Any) -> dict: ...
