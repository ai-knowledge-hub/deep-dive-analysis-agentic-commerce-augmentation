...
class ValidationJobsStore(Protocol):
    ...
    def get_job_for_effect_execution(self, **kwargs: Any) -> dict | None: ...
...
class AgentRunsStore(Protocol):
    ...
    def transition_agent_run_status(self, **kwargs: Any) -> dict | None: ...
    ...
    def delete_agent_run(self, **kwargs: Any) -> bool: ...

    def list_agent_runs(self, **kwargs: Any) -> list[dict]: ...

    def list_agent_runs_missing_registry_pins(self, **kwargs: Any) -> list[dict]: ...

    def backfill_agent_run_registry_pins(self, **kwargs: Any) -> int: ...

    def list_runnable_agent_runs(self, **kwargs: Any) -> list[dict]: ...

    def acquire_run_lock(self, **kwargs: Any) -> bool: ...

    def heartbeat_run_lock(self, **kwargs: Any) -> bool: ...

    def release_run_lock(self, **kwargs: Any) -> bool: ...
...
class AgentActionsStore(Protocol):
    ...
    def transition_agent_action_status(self, **kwargs: Any) -> dict | None: ...

    def get_agent_action(self, **kwargs: Any) -> dict | None: ...

    def list_agent_actions(self, **kwargs: Any) -> list[dict]: ...

    def list_agent_actions_missing_registry_pins(self, **kwargs: Any) -> list[dict]: ...

    def update_agent_action_registry_pins(self, **kwargs: Any) -> dict | None: ...
