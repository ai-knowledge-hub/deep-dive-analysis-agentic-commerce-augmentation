...
from db.repositories import episodes as episodes_repo
from db.repositories import goals as goals_repo
from db.repositories import recommendations as recommendations_repo
from db.repositories import sessions as sessions_repo
from db.repositories import semantic as semantic_repo
from db.repositories import turns as turns_repo
...
class SessionManager:
    ...
    # ------------------------------------------------------------------ turns
    def record_turn(self, speaker: str, content: str, metadata: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    # ---------------------------------------------------------------- episodic memory
    def record_reflection(self, reflection_text: str, outcome: str | None = "reflection_summary") -> Dict[str, Any]:
