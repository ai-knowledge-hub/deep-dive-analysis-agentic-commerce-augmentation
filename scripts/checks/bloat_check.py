...
FILE_MAX_LINES = {
    ...
    "application/services/agent_runtime/capabilities.py": 850,
    ...
    "application/services/agent_runtime/runtime.py": 400,
    "application/services/agent_runtime/runtime_audit.py": 140,
