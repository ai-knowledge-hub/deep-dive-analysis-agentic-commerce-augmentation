...
- `agent-first-migration-slice-rfc.md`: first agent-first migration slice rationale; implemented.
- `app-workflows.md`: older workflow map with useful API and product-flow notes.
- `experiment-flow-detailed.md`: lab-era experiment protocol reference.
- `user-guide-complete.md`: older human-led product guide, superseded by `../operator-experience.md`.
